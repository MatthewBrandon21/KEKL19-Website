                                            ...
                                            <div class="flex-grow-1">
                                                <div>
                                                    <?php if ($users['fullname'] != NULL && $users['fullname'] != "") : ?>
                                                        <h5 class="font-size-16 mb-1"><?= $users['fullname']; ?></h5>
                                                    <?php endif; ?>
                                                    <p class="text-muted font-size-13"><?= $users['username']; ?></p>
                                                    <div class="d-flex flex-wrap align-items-start gap-2 gap-lg-3 text-muted font-size-13">
                                                        ...
                                                        <?php if ($users['email'] != NULL && $users['email'] != "") : ?>
                                                            <div><i class="mdi mdi-circle-medium me-1 text-success align-middle"></i><?= $users['email']; ?></div>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div>
                                    <ul class="list-unstyled mb-0">
                                        ...
                                        <?php if ($users['line'] != NULL && $users['line'] != "") : ?>
                                            <li>
                                                <a href="http://line.me/ti/p/~<?= $users['line']; ?>" class="py-2 d-block text-muted"><i class="fab fa-line text-primary me-1"></i> <?= $users['line']; ?></a>
                                            </li>
                                        <?php endif; ?>
