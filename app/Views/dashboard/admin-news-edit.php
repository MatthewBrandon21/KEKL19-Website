                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                <form action="<?= base_url(); ?>/admin-news/edit-action/<?= $news['id']; ?>" method="post" class="needs-validation" enctype="multipart/form-data" novalidate>
                                    <?= csrf_field(); ?>
                                    <input type="hidden" name="slug" value="<?= $news['slug']; ?>">
                                    <input type="hidden" name="oldfiles" value="<?= $news['post_image']; ?>">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div>
                                                <div class="mb-3">
                                                    <label for="title" class="form-label">Title</label>
                                                    <input class="form-control" type="text" id="title" name="title" value="<?= (old('title')) ? old('title') : $news['title']; ?>" required autofocus>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" type="url" id="link" name="link" value="<?= (old('link')) ? old('link') : $news['moreinfo_link']; ?>" required>
                                                    <div class="valid-feedback">
                                                        Looks good!
                                                    </div>
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea id="body" name="body" class="form-control" rows="2" required><?= (old('body')) ? old('body') : $news['body']; ?></textarea>
                                                    <div class="valid-feedback">
                                                        Looks good!
                                                    </div>
                                                    <div class="invalid-feedback">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" name="status" required>
                                                        <option><?= (old('status')) ? old('status') : $news['status']; ?></option>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <img src="<?= base_url(); ?>/assets/images/<?= $news['post_image']; ?>" class="mb-3 img-thumbnail img-preview">
                                                    <div class="input-group mb-3">
                                                        <input type="file" class="form-control" id="post_image" name="post_image" onchange="previewimg()">
                                                        <div class="valid-feedback">
                                                            Looks good!
                                                        </div>
                                                        <div class="invalid-feedback">
