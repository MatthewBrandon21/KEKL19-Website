        ...
        <div class="d-flex">
            <div class="navbar-brand-box">
                <a href="<?= base_url(); ?>/dashboard" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="<?= base_url(); ?>/assets/images/logo-kekl19-2000x1623.png" alt="" height="24">
                    </span>
                    <span class="logo-lg">
                        <img src="<?= base_url(); ?>/assets/images/logo-kekl19-2000x1623.png" alt="" height="24"> <span class="logo-txt">Dashboard</span>
                    </span>
                </a>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <a class="dropdown-item" href="<?= base_url(); ?>/profile"><i class="mdi mdi-face-profile font-size-16 align-middle me-1"></i> <?= lang('Files.Profile') ?></a>
