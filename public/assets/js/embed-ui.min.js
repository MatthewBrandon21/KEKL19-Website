...
(function() {
    ...
    var Ca = Array.prototype.indexOf ? function(a, b) {
        ...
        Da = Array.prototype.filter ? function(a, b) {
            return Array.prototype.filter.call(a, b, void 0)
        } : function(a, b) {
            for (var c =
                    a.length, d = [], f = 0, g = l(a) ? a.split("") : a, k = 0; k < c; k++)
                if (k in g) {
                    var u = g[k];
    ...
    Ta.prototype.add = function(a, b, c, d, f) {
        ...
        a = this.a[g];
        a || (a = this.a[g] = [], this.b++);
        var k = Ua(a, b, d, f); - 1 < k ? (b = a[k], c || (b.sa = !1)) : (b = new Ra(b, this.src, g, !!d, f), b.sa = c, a.push(b));
        return b
    };
    ...
    function Cb(a, b, c, d, f) {
        if (ea(b))
            for (var g = 0; g < b.length; g++) Cb(a, b[g], c, d, f);
        else d = fa(d) ? !!d.capture : !!d, c = wb(c), Pa(a) ? (a = a.O, b = String(b).toString(), b in a.a && (g = a.a[b], c = Ua(g, c, d, f), -1 < c && (Sa(g[c]), Array.prototype.splice.call(g, c, 1), 0 == g.length && (delete a.a[b], a.b--)))) : a && (a = yb(a)) && (c = Wa(a, b, c, d, f)) && Db(c)
    }
    ...
    function Bb(a, b) {
        ...
        if (!mb) {
            ...
            if (!(0 > d.keyCode || void 0 != d.returnValue)) {
                ...
                d = [];
                for (f = b.b; f; f = f.parentNode) d.push(f);a = a.type;
                for (f = d.length - 1; !b.i && 0 <= f; f--) {
                    b.b = d[f];
                    var g = Eb(d[f], a, !0, b);
                    c = c && g
                }
                for (f = 0; !b.i && f < d.length; f++) b.b = d[f],
                g = Eb(d[f], a, !1, b),
                c = c && g
            }
            return c
    ...
    function A(a, b) {
        ...
        if (c)
            for (g = 0; !b.i && g < c.length; g++) k = b.b = c[g], f = Hb(k, d, !1, b) && f
    }
    ...
    e.ub = function() {
        if (this.W) {
            var a = la() - this.m;
            0 < a && a < .8 * this.a ? this.U = this.b.setTimeout(this.i, this.a - a) : (this.U && (this.b.clearTimeout(this.U), this.U = null), A(this, "tick"), this.W && (this.U = this.b.setTimeout(this.i, this.a), this.m = la()))
        }
    };
    e.start = function() {
        this.W = !0;
    ...
    function Yb(a) {
        return Ob && void 0 != a.children ? a.children : Da(a.childNodes, function(b) {
            return 1 == b.nodeType
        })
    }
    ...
    function hc(a) {
        ...
        if (w) {
            ...
            b = new Mb(f, d, g, b)
        } else b = cc(a, "paddingLeft"), d = cc(a, "paddingRight"), f = cc(a, "paddingTop"), g = cc(a, "paddingBottom"), b = new Mb(parseFloat(f),
            parseFloat(d), parseFloat(g), parseFloat(b));
        !w || 9 <= Number(kb) ? (d = cc(a, "borderLeftWidth"), f = cc(a, "borderRightWidth"), g = cc(a, "borderTopWidth"), a = cc(a, "borderBottomWidth"), a = new Mb(parseFloat(g), parseFloat(f), parseFloat(a), parseFloat(d))) : (d = kc(a, "borderLeft"), f = kc(a, "borderRight"), g = kc(a, "borderTop"), a = kc(a, "borderBottom"), a = new Mb(g, f, a, d));
    ...
    function oc(a, b, c, d, f, g) {
        if (ea(c))
            for (var k = 0; k < c.length; k++) oc(a, b, c[k], d, f, g);
        else d = d || a.handleEvent, f = fa(f) ? !!f.capture : !!f, g = g || a.b || a, d = wb(d), f = !!f, c = Pa(b) ? Wa(b.O, String(c), d, f, g) : b ? (b = yb(b)) ? Wa(b, c, d, f, g) : null : null, c && (Db(c), delete a.a[c.key])
    }
    ...
    e.T = function(a, b) {
        ...
        tc(a, this);
        Ia(this.B, c, 0, a);
        a.H && this.H && a.F == this ? (b = this.ia(), c = b.childNodes[c] || null, c != a.c() && b.insertBefore(a.c(), c)) : b ? (this.m || this.w(),
            c = L(this, c + 1), I(a, this.ia(), c ? c.m : null)) : this.H && !a.H && a.m && a.m.parentNode && 1 == a.m.parentNode.nodeType && a.A()
    };
    e.ia = function() {
        return this.m
    };
    ...
    function Hc(a, b) {
        if (a.l != b) {
            ...
            c && (a.a ? a.o = b : (a.C = Bc * (null === a.l ? .3 : 1), a.l = b, a.o = null, a.a || (a.a = D(a.i, "IMG"), a.b.appendChild(a.a), E(a.a, Jc), b = a.C, E(a.a, "transition", 0 < b ? "opacity " + .001 * b + "s ease" : "none"), x(a.a, "load", a.Db, !1, a)), E(a.a, "z-index", 2), F(a.a, 0), a.a.src = c.src))
        }
    }
    ...
    function Pc(a, b) {
        ...
        if (1 < c) {
            ...
            if (a instanceof Pc)
                for (c = a.Fa(), d = 0; d < c.length; d++) this.set(c[d], a.get(c[d]));
            else
    ...
    Zc.prototype.log = function(a, b, c) {
        if (a.value >= dd(this).value)
            for ("function" == da(b) && (b = b()), a = new Xc(a, String(b), this.m), c && (a.a = c), c = this; c;) c = c.a
    };
    var ed = {},
        fd = null;
    ...
    function pd(a, b) {
        ...
        try {
            sd(a), 0 < a.F && (a.j = td(a.a), Q(a.b, qd(a, "Will abort after " + a.F + "ms if incomplete, xhr2 " + a.j)), a.j ? (a.a.timeout = a.F, a.a.ontimeout = m(a.ib, a)) : a.h = Kb(a.ib, a.F, a)), Q(a.b, qd(a, "Sending request")), a.f = !0, a.a.send(""), a.f = !1
        } catch (f) {
    ...
    e.za = function() {
        var a = this.c();
        this.ga ? (a = Yb(a), t(a, function(b) {
            F(b, !0 === this.fa ? 1 : 0)
        }, this)) : F(a, !0 === this.fa ? 1 : 0)
    };
    e.update = function() {
    ...
    function ze(a, b) {
        ...
        l(b.description) && (c = new ae, c.b =
            b.description, O(c) && $b(c.a, null !== c.b ? c.b : ""), a.T(c, !0))
    }
    e.pb = function() {
    ...
    function Pe(a) {
        var b = a.h ? 1 : a.G,
            c = a.c();
        E(c, "transition-delay", (a.h ? 0 : .001 * a.C) + "s");
        F(c, b)
    }
    ...
    var Hf = new Nb(-3, -3, 24, 24),
        ...
        Af = new U("M19 19H5V5h7V3H5c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2v-7h-2v7zM14 3v2h3.59l-9.83 9.83 1.41 1.41L19 6.41V10h2V3h-7z",
            X),
        Mf = new U("M18 16.08c-.76 0-1.44.3-1.96.77L8.91 12.7c.05-.23.09-.46.09-.7s-.04-.47-.09-.7l7.05-4.11c.54.5 1.25.81 2.04.81 1.66 0 3-1.34 3-3s-1.34-3-3-3-3 1.34-3 3c0 .24.04.47.09.7L8.04 9.81C7.5 9.31 6.79 9 6 9c-1.66 0-3 1.34-3 3s1.34 3 3 3c.79 0 1.5-.31 2.04-.81l7.12 4.16c-.05.21-.08.43-.08.65 0 1.61 1.31 2.92 2.92 2.92 1.61 0 2.92-1.31 2.92-2.92s-1.31-2.92-2.92-2.92z", new Nb(-7, -8, 40, 40)),
        Nf = new U("M8 5v14l11-7z", X),
        Of = new U("M6 19h4V5H6v14zm8-14v14h4V5h-4z", X),
        Pf = new U("M7 7h10v3l4-4-4-4v3H5v6h2V7zm10 10H7v-3l-4 4 4 4v-3h12v-6h-2v4z",
            X),
    ...
    Ag.prototype.f = function(a) {
        ...
        a && 1 == a.length && (B(this, "gtouchhmove") || B(this, "gtouchvmove") ? (this.i.a = a[0].clientX, this.i.b = a[0].clientY, this.b = null) : B(this, "gtouchstart") && (b = new Cg("gtouchstart", this, a), A(this, b)), x(this.a, "touchmove", this.F, !1, this), x(this.a, "touchend", this.B, !1, this))
    };
    Ag.prototype.F = function(a) {
        this.m = !0;
        var b = Bg(a),
        ...
        B(this,
            "gmultitouchmove") && (f = new Cg("gmultitouchmove", this, b), A(this, f), a.a())
    };
